...
This is the firmware for certain STM32F042x/STM32F072xB-based USB-CAN adapters, notably:
...
Building requires the arm-none-eabi-gcc toolchain.
...
- Flash the device with: `make flash-canalyze_fw` or `sudo dfu-util --dfuse-address -d 0483:df11 -c 1 -i 0 -a 0 -s 0x08000000 -D CORRECT_FIRWARE.bin` where CORRECT_FIRWARE is the name of the desired .bin.
